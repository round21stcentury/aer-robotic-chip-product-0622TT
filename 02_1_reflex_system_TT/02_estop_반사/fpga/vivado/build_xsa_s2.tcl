# build_xsa_s2.tcl — 스텝2: bd 래퍼 → 합성/구현/비트 → XSA.
#   전제: create_project_s2 + add_reflex_s2.  실행: vivado -mode batch -source build_xsa_s2.tcl
...
set xsa "$here/reflex_vivado/reflex_s2.xsa"
