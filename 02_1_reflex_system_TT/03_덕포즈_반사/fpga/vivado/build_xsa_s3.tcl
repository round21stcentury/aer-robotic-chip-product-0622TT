# build_xsa_s3.tcl — 스텝3: bd 래퍼 → 합성/구현/비트 → XSA.
#   전제: create_project_s3 + add_reflex_s3.  실행: vivado -mode batch -source build_xsa_s3.tcl
...
set xsa "$here/reflex_vivado/reflex_s3.xsa"
