...
#   ★Vitis 는 한글경로서 깨짐 → 워크스페이스는 ASCII (_vitis_ws/s5).
...
WS   = os.path.join(ASCII_ROOT, "_vitis_ws", "s5")
...
def main():
    ...
    shutil.copy(SRC, dst)
    inject = ""
    for env_name, macro in [("SPI_DIV","SPI_DIV_CODE"), ("PACE_US","PACE_US"), ("THRESH_CODE","THRESH_CODE"), ("FSR_RULE","FSR_RULE"), ("FLINCH_TICKS","FLINCH_TICKS"), ("RECOIL_RAW","RECOIL_RAW"), ("REFLEX_SPEED","REFLEX_SPEED")]:
