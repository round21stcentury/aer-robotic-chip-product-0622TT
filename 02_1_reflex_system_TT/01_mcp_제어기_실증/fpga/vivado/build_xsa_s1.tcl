# build_xsa_s1.tcl — 스텝1: bd 래퍼 → 합성/구현/비트 → XSA.
#   전제: create_project_s1 + add_reflex_s1.  실행: vivado -mode batch -source build_xsa_s1.tcl
...
set xsa "$here/reflex_vivado/reflex_s1.xsa"
