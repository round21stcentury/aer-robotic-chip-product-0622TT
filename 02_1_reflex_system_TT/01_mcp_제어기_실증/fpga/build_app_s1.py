# build_app_s1.py — 스텝1 PS 앱 (★lwIP 정상명령 패스스루 브리지) Vitis 빌드
#   05 build_hil_app.py 흐름 재사용: 플랫폼 + lwip220 + lwip_echo_server 템플릿 + main.c 교체.
#   ★Vitis 는 한글경로서 깨짐 → 워크스페이스는 ASCII (메모리 vitis-ascii-path).
...
def main():
    ...
    print(">> main.c ← reflex_s1_main.c 교체")
