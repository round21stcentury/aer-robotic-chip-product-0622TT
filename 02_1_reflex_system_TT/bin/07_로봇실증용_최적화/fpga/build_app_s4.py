...
def main():
    ...
    shutil.copy(SRC, dst)
    inject = ""
    for env_name, macro in [("SPI_DIV","SPI_DIV_CODE"), ("PACE_US","PACE_US"), ("CLK_MHZ","CLK_MHZ"), ("THRESH_CODE","THRESH_CODE"), ("FSR_RULE","FSR_RULE"), ("FLINCH_TICKS","FLINCH_TICKS"), ("RECOIL_RAW","RECOIL_RAW"), ("REFLEX_SPEED","REFLEX_SPEED")]:
