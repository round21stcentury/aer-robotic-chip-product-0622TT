...
##Pmod Header JE    
set_property -dict { PACKAGE_PIN V12   IOSTANDARD LVCMOS33 } [get_ports CAN_0_0_tx ]; #IO_L4P_T0_34 Sch=je[1]						 
set_property -dict { PACKAGE_PIN W16   IOSTANDARD LVCMOS33 } [get_ports CAN_0_0_rx ]; #IO_L18N_T2_34 Sch=je[2]                                                                                                                  
