...
CTU_FEE:ctu_can_fd_rtl:CTU_CAN_FD:3.0\
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set CAN_0_0_phy_rx [ create_bd_port -dir I CAN_0_0_phy_rx ]
  set CAN_0_0_phy_tx [ create_bd_port -dir O -from 0 -to 0 CAN_0_0_phy_tx ]
...
\
  ...
  set CTU_CAN_FD_0 [ create_bd_cell -type ip -vlnv CTU_FEE:ctu_can_fd_rtl:CTU_CAN_FD:3.0 CTU_CAN_FD_0 ]
  ...
  connect_bd_intf_net -intf_net axi_apb_bridge_0_APB_M [get_bd_intf_pins axi_apb_bridge_0/APB_M] [get_bd_intf_pins CTU_CAN_FD_0/s_apb]
  ...
  connect_bd_intf_net -intf_net smartconnect_0_M00_AXI [get_bd_intf_pins smartconnect_0/M00_AXI] [get_bd_intf_pins axi_apb_bridge_0/AXI4_LITE]

  # Create port connections
  connect_bd_net -net CAN_rx_0_1  [get_bd_ports CAN_0_0_phy_rx] \
  [get_bd_pins CTU_CAN_FD_0/CAN_rx] \
  [get_bd_pins processing_system7_0/CAN0_PHY_RX]
  connect_bd_net -net CTU_CAN_FD_0_CAN_tx  [get_bd_pins CTU_CAN_FD_0/CAN_tx] \
  [get_bd_pins ilvector_logic_0/Op2]
  connect_bd_net -net ilvector_logic_0_Res  [get_bd_pins ilvector_logic_0/Res] \
  [get_bd_ports CAN_0_0_phy_tx]
  connect_bd_net -net processing_system7_0_CAN0_PHY_TX  [get_bd_pins processing_system7_0/CAN0_PHY_TX] \
  [get_bd_pins ilvector_logic_0/Op1]
  connect_bd_net -net processing_system7_0_FCLK_CLK0  [get_bd_pins processing_system7_0/FCLK_CLK0] \
  [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] \
  [get_bd_pins CTU_CAN_FD_0/aclk] \
  ...
  [get_bd_pins CTU_CAN_FD_0/arstn] \
  [get_bd_pins axi_apb_bridge_0/s_axi_aresetn]
  connect_bd_net -net xlconstant_0_dout  [get_bd_pins xlconstant_0/dout] \
  [get_bd_pins CTU_CAN_FD_0/scan_enable]
  connect_bd_net -net xlconstant_1_dout  [get_bd_pins xlconstant_1/dout] \
  [get_bd_pins CTU_CAN_FD_0/timestamp]

  # Create address segments
  assign_bd_address -offset 0x43C00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs CTU_CAN_FD_0/s_apb/Reg] -force
